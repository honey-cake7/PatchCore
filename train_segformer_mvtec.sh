#!/bin/bash
#SBATCH --job-name=patchcore-segformer-mvtec
#SBATCH --partition=LocalQ
#SBATCH --account=default
#SBATCH --gres=gpu:1
#SBATCH --gres=shard:32
#SBATCH --ntasks=1
#SBATCH --output=/home/user1/aniket/Patchcore/logs/patchcore_segformer_mvtec%j.out
#SBATCH --error=/home/user1/aniket/Patchcore/logs/patchcore_segformer_mvtec%j.err
...
mkdir -p results
echo "Starting MVTec PatchCore training with SegFormer MiT-b3 backbone..."
...
env PYTHONPATH=src python bin/run_patchcore.py \
  ...
  --log_group IM224_SegFormerB3_MVTec_S12_P01 \
