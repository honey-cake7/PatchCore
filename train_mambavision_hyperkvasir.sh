#!/bin/bash
#SBATCH --job-name=hyperkvasir-patchcore-mambavision
#SBATCH --partition=LocalQ
#SBATCH --account=default
#SBATCH --gres=gpu:1
#SBATCH --gres=shard:32
#SBATCH --ntasks=1
#SBATCH --output=/home/user1/aniket/Patchcore/logs/hyperkvasir_mambavision_%j.out
#SBATCH --error=/home/user1/aniket/Patchcore/logs/hyperkvasir_mambavision_%j.err
...
mkdir -p results
echo "Starting HyperKvasir PatchCore training with MambaVision-T backbone..."
...
env PYTHONPATH=src python bin/run_patchcore.py \
  ...
  --log_group IM224_MambaVisionT_s12_HyperKvasir \
