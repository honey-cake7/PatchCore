#!/bin/bash
#SBATCH --job-name=patchcore-polyp-pvt
#SBATCH --partition=LocalQ
#SBATCH --account=default
#SBATCH --gres=gpu:1
#SBATCH --gres=shard:32
#SBATCH --ntasks=1
#SBATCH --output=/home/user1/aniket/Patchcore/logs/patchcore_polyppvt%j.out
#SBATCH --error=/home/user1/aniket/Patchcore/logs/patchcore_polyppvt%j.err
...
mkdir -p results
echo "Starting Kvasir PatchCore training with Polyp-PVT (PVTv2-B2) backbone..."
...
env PYTHONPATH=src python bin/run_patchcore.py \
  ...
  --log_group IM224_PolypPVT_norm23_P01 \
